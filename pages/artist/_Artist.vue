									...
									>
										...
										>
											<a
												...
												class="icon-holder"
												:href="'https://www.instagram.com/' + artistInfo.acf.instagram_handle + '/'"
												target="_blank"
											>
										...
										<li
											v-if="
												artistInfo.acf.consultation_form_url || artistInfo.acf.consultation_email
											"
										...
										>
											<a
												v-if="
													artistInfo.acf.consultation_form_url &&
													artistInfo.acf.form_or_email == 'form'
												"
												class="icon-holder"
											...
											<a
												...
												>Consultation w/ {{ artistInfo.title.rendered.split(' ')[0] }}</a
											>
											<a
												v-if="
													artistInfo.acf.consultation_email &&
													artistInfo.acf.form_or_email == 'email'
												"
												class="icon-holder"
										...
										>
											<p v-if="artistInfo.acf.bio" class="text order-2 order-lg-1">
												{{ artistInfo.acf.bio }}
											</p>
...
export default {
	...
	head() {
		return {
			title: `Tattoo Salvation | ${this.artistInfo.title.rendered}`,
			meta: [
